...
docker run --gpus all --rm \
    ...
    --shm-size=1G \
    -e HOME=/$USER xehartnort/pygpu:latest /bin/bash -c "bash /mariogmarq/flex-block/install_deps.sh && cd /mariogmarq/flex-block/flexBlock/experiments/attacks/cifar10 && python cifar10.py"
